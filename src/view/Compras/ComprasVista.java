...
public class ComprasVista extends javax.swing.JPanel {
    ...
    private ComprasVista compraVista;
    private int id;
    private DefaultTableModel modeloTabla;

    public ComprasVista(Usuario usuario) {
        initComponents();
        iniciarModeloTabla();
        inicio();
        configurarEventos();
    ...
    private void inicio() {
        ...
        comboProveedor.setForeground(labelColor);
    ...
    private void initComponents() {
        ...
        add(comboProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 460, 150, -1));

        lblTotalFinal.setText("Total de la compra:");
        add(lblTotalFinal, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 500, -1, -1));
        add(txtTotalCompra, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 500, 110, -1));

        btnRealizarCompra.setText("Realizar Compra");
        add(btnRealizarCompra, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 470, 180, 40));
